 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element ref="{}Bottle" maxOccurs="unbounded"/>
 *           &lt;element ref="{}nopdf" maxOccurs="unbounded"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 ...
 *       &lt;attribute name="kassa" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
...
public class Cheque {
    ...
    protected List<Bottle> bottle;
    protected List<Nopdf> nopdf;
    ...
    /**
     * Gets the value of the nopdf property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nopdf property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNopdf().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Nopdf> getNopdf() {
        if (nopdf == null) {
            nopdf = new ArrayList<Nopdf>();
        }
        return this.nopdf;
    }
