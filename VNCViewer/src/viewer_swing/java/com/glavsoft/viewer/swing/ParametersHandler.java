...
public class ParametersHandler {
	...
	public static final String ARG_SSH_PASSWORD = "sshPassword";
    ...
    public static void completeParserOptions(Parser parser) {
		...
		parser.addOption(ARG_SSH_PASSWORD, "", "SSH Password.");
	...
	private static int completeSettings(ParamsRetriever pr, ConnectionParams connectionParams, ProtocolSettings rfbSettings, UiSettings uiSettings) {
        ...
        String sshPasswordParam = pr.getParamByName(ARG_SSH_PASSWORD);
        ...
        connectionParams.sshPassword = sshPasswordParam;
