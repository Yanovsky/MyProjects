 ...
 * 
 */
@XmlType(name = "WbUnitType", namespace = "http://fsrar.ru/WEGAIS/TTNSingle")
@XmlEnum
public enum WbUnitType2 {
    ...
    public static WbUnitType2 fromValue(String v) {
        for (WbUnitType2 c: WbUnitType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
