...
@XmlType(name = "ActChargeOnPositionType", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn", propOrder = {

})
public class ActChargeOnPositionType {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn", required = true)
    protected String identity;
    @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn", required = true)
    protected ProductInfo product;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "InformAB", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn", required = true)
    protected ActChargeOnPositionType.InformAB informAB;
    @XmlElement(name = "MarkCodeInfo", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn")
    protected MarkCodeInfoType2 markCodeInfo;
     ...
     * @return
     *     possible object is
     *     {@link MarkCodeInfoType2 }
     *     
     */
    public MarkCodeInfoType2 getMarkCodeInfo() {
        return markCodeInfo;
    }
     ...
     *     
     */
    public void setMarkCodeInfo(MarkCodeInfoType2 value) {
    ...
    public static class InformAB {
        ...
        @XmlElement(name = "InformABKey", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn")
        protected InformABKeyType informABKey;
        @XmlElement(name = "InformABReg", namespace = "http://fsrar.ru/WEGAIS/ActChargeOn")
