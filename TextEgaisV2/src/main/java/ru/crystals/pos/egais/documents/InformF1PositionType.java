...
@XmlType(name = "InformF1PositionType", namespace = "http://fsrar.ru/WEGAIS/RepInformF1Reg", propOrder = {

})
public class InformF1PositionType {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/RepInformF1Reg", required = true)
    protected String identity;
    @XmlElement(name = "InformF1RegId", namespace = "http://fsrar.ru/WEGAIS/RepInformF1Reg", required = true)
    protected String informF1RegId;
    @XmlElement(name = "InformF2RegId", namespace = "http://fsrar.ru/WEGAIS/RepInformF1Reg")
