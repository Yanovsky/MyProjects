...
@XmlType(name = "RequestRepealWB", namespace = "http://fsrar.ru/WEGAIS/RequestRepealWB", propOrder = {

})
public class RequestRepealWB {

    @XmlElement(name = "ClientId", namespace = "http://fsrar.ru/WEGAIS/RequestRepealWB", required = true)
    protected String clientId;
    @XmlElement(name = "RequestNumber", namespace = "http://fsrar.ru/WEGAIS/RequestRepealWB", required = true)
    protected String requestNumber;
    @XmlElement(name = "RequestDate", namespace = "http://fsrar.ru/WEGAIS/RequestRepealWB", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar requestDate;
    @XmlElement(name = "WBRegId", namespace = "http://fsrar.ru/WEGAIS/RequestRepealWB", required = true)
