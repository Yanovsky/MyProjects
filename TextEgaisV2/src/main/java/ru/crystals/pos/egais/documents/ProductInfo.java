...
@XmlType(name = "ProductInfo", namespace = "http://fsrar.ru/WEGAIS/ProductRef", propOrder = {

})
public class ProductInfo {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    protected String identity;
    @XmlElement(name = "Type", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    @XmlSchemaType(name = "string")
    protected ProductType type;
    @XmlElement(name = "FullName", namespace = "http://fsrar.ru/WEGAIS/ProductRef", required = true)
    protected String fullName;
    @XmlElement(name = "ShortName", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    protected String shortName;
    @XmlElement(name = "AlcCode", namespace = "http://fsrar.ru/WEGAIS/ProductRef", required = true)
    protected String alcCode;
    @XmlElement(name = "Capacity", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    protected BigDecimal capacity;
    @XmlElement(name = "AlcVolume", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    protected BigDecimal alcVolume;
    @XmlElement(name = "Producer", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    protected OrgInfo producer;
    @XmlElement(name = "Importer", namespace = "http://fsrar.ru/WEGAIS/ProductRef")
    protected OrgInfo importer;
    @XmlElement(name = "ProductVCode", namespace = "http://fsrar.ru/WEGAIS/ProductRef", required = true)
