...
@XmlType(name = "ReplyForm1", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", propOrder = {

})
public class ReplyForm1 {

    @XmlElement(name = "InformF1RegId", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    protected String informF1RegId;
    @XmlElement(name = "OriginalClient", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    protected OrgInfoRusReplyV2 originalClient;
    @XmlElement(name = "OriginalDocNumber", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    protected String originalDocNumber;
    @XmlElement(name = "OriginalDocDate", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar originalDocDate;
    @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    protected ProductInfoReplyV2 product;
    @XmlElement(name = "BottlingDate", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar bottlingDate;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "EGAISNumber", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    protected String egaisNumber;
    @XmlElement(name = "EGAISDate", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar egaisDate;
    @XmlElement(name = "GTDNUMBER", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1")
    protected String gtdnumber;
    @XmlElement(name = "GTDDate", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar gtdDate;
    @XmlElement(name = "MarkInfo", namespace = "http://fsrar.ru/WEGAIS/ReplyForm1")
