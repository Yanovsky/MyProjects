...
@XmlType(name = "OperationResultType", namespace = "http://fsrar.ru/WEGAIS/Ticket", propOrder = {

})
public class OperationResultType {

    @XmlElement(name = "OperationName", namespace = "http://fsrar.ru/WEGAIS/Ticket", required = true)
    protected String operationName;
    @XmlElement(name = "OperationResult", namespace = "http://fsrar.ru/WEGAIS/Ticket", required = true)
    @XmlSchemaType(name = "string")
    protected ConclusionType operationResult;
    @XmlElement(name = "OperationComment", namespace = "http://fsrar.ru/WEGAIS/Ticket", required = true)
    protected String operationComment;
    @XmlElement(name = "OperationDate", namespace = "http://fsrar.ru/WEGAIS/Ticket")
