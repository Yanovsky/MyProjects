...
@XmlType(name = "PositionType", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct", propOrder = {

})
public class PositionType4 {

    @XmlElement(name = "ProductCode", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct", required = true)
    protected String productCode;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "Party", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct")
    protected String party;
    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct", required = true)
    protected String identity;
    @XmlElement(name = "Comment1", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct")
    protected String comment1;
    @XmlElement(name = "Comment2", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct")
    protected String comment2;
    @XmlElement(name = "Comment3", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct")
    protected String comment3;
    @XmlElement(name = "MarkInfo", namespace = "http://fsrar.ru/WEGAIS/RepImportedProduct")
