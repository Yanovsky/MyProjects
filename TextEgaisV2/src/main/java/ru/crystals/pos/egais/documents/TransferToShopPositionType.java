...
@XmlType(name = "TransferToShopPositionType", namespace = "http://fsrar.ru/WEGAIS/TransferToShop", propOrder = {

})
public class TransferToShopPositionType {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/TransferToShop", required = true)
    protected String identity;
    @XmlElement(name = "ProductCode", namespace = "http://fsrar.ru/WEGAIS/TransferToShop", required = true)
    protected String productCode;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/TransferToShop", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "InformF2", namespace = "http://fsrar.ru/WEGAIS/TransferToShop", required = true)
