...
@XmlType(name = "InformF2PositionType", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", propOrder = {

})
public class InformF2PositionType {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
    protected String identity;
    @XmlElement(name = "InformF2RegId", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
    protected String informF2RegId;
    @XmlElement(name = "BottlingDate", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg")
