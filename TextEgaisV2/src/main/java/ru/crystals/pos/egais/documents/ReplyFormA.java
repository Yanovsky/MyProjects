...
@XmlType(name = "ReplyFormA", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", propOrder = {

})
public class ReplyFormA {

    @XmlElement(name = "InformARegId", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    protected String informARegId;
    @XmlElement(name = "TTNNumber", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    protected String ttnNumber;
    @XmlElement(name = "TTNDate", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar ttnDate;
    @XmlElement(name = "Shipper", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    protected OrgInfo shipper;
    @XmlElement(name = "Consignee", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    protected OrgInfo consignee;
    @XmlElement(name = "ShippingDate", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar shippingDate;
    @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    protected ProductInfo product;
    @XmlElement(name = "BottlingDate", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar bottlingDate;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "EGAISNumber", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA")
    protected String egaisNumber;
    @XmlElement(name = "EGAISDate", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar egaisDate;
    @XmlElement(name = "MarkInfo", namespace = "http://fsrar.ru/WEGAIS/ReplyFormA")
