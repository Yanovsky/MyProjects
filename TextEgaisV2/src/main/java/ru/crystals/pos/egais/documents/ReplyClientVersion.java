...
@XmlType(name = "ReplyClientVersion", namespace = "http://fsrar.ru/WEGAIS/ReplyClientVersion", propOrder = {
    "versionDate",
    "client"
})
public class ReplyClientVersion {

    @XmlElement(name = "VersionDate", namespace = "http://fsrar.ru/WEGAIS/ReplyClientVersion", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar versionDate;
    @XmlElement(name = "Client", namespace = "http://fsrar.ru/WEGAIS/ReplyClientVersion")
