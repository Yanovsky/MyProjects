...
@XmlType(name = "UsedResourceType", namespace = "http://fsrar.ru/WEGAIS/RepProducedProduct", propOrder = {

})
public class UsedResourceType {

    @XmlElement(name = "IdentityRes", namespace = "http://fsrar.ru/WEGAIS/RepProducedProduct", required = true)
    protected String identityRes;
    @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/RepProducedProduct", required = true)
    protected ProductInfoV2 product;
    @XmlElement(name = "RegForm2", namespace = "http://fsrar.ru/WEGAIS/RepProducedProduct")
