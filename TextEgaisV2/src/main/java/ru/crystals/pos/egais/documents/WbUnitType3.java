 ...
 * 
 */
@XmlType(name = "WbUnitType", namespace = "http://fsrar.ru/WEGAIS/ProductRef_v2")
@XmlEnum
public enum WbUnitType3 {
    ...
    public static WbUnitType3 fromValue(String v) {
        for (WbUnitType3 c: WbUnitType3 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
