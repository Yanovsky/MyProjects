...
@XmlType(name = "QueryFormF1F2", namespace = "http://fsrar.ru/WEGAIS/QueryFormF1F2", propOrder = {
    "formRegId"
})
public class QueryFormF1F2 {

    @XmlElement(name = "FormRegId", namespace = "http://fsrar.ru/WEGAIS/QueryFormF1F2", required = true)
