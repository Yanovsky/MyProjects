...
@XmlType(name = "ReplyRestsShop_v2", namespace = "http://fsrar.ru/WEGAIS/ReplyRestsShop_v2", propOrder = {
    "restsDate",
    "products"
})
public class ReplyRestsShopV2 {

    @XmlElement(name = "RestsDate", namespace = "http://fsrar.ru/WEGAIS/ReplyRestsShop_v2", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar restsDate;
    @XmlElement(name = "Products", namespace = "http://fsrar.ru/WEGAIS/ReplyRestsShop_v2")
    ...
    public static class Products {
        ...
        @XmlElement(name = "ShopPosition", namespace = "http://fsrar.ru/WEGAIS/ReplyRestsShop_v2")
