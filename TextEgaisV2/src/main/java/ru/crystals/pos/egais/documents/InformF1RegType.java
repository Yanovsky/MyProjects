...
@XmlType(name = "InformF1RegType", namespace = "http://fsrar.ru/WEGAIS/ActInventoryF1F2Info", propOrder = {
...
public class InformF1RegType {
    ...
    @XmlElement(name = "BottlingDate", namespace = "http://fsrar.ru/WEGAIS/ActInventoryF1F2Info", required = true)
    ...
    @XmlElement(name = "EGAISFixNumber", namespace = "http://fsrar.ru/WEGAIS/ActInventoryF1F2Info")
    protected String egaisFixNumber;
    @XmlElement(name = "EGAISFixDate", namespace = "http://fsrar.ru/WEGAIS/ActInventoryF1F2Info")
    @XmlSchemaType(name = "date")
