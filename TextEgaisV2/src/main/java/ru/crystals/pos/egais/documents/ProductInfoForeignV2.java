...
@XmlType(name = "ProductInfoForeign_v2", namespace = "http://fsrar.ru/WEGAIS/ProductRef_v2", propOrder = {
...
public class ProductInfoForeignV2 {
    ...
    @XmlElement(name = "Importer", namespace = "http://fsrar.ru/WEGAIS/ProductRef_v2", required = true)
