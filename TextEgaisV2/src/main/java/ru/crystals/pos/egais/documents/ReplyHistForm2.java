...
@XmlType(name = "ReplyHistForm2", namespace = "http://fsrar.ru/WEGAIS/ReplyHistForm2", propOrder = {

})
public class ReplyHistForm2 {

    @XmlElement(name = "InformF2RegId", namespace = "http://fsrar.ru/WEGAIS/ReplyHistForm2")
    protected String informF2RegId;
    @XmlElement(name = "HistForm2Date", namespace = "http://fsrar.ru/WEGAIS/ReplyHistForm2", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar histForm2Date;
    @XmlElement(name = "HistoryF2", namespace = "http://fsrar.ru/WEGAIS/ReplyHistForm2", required = true)
    ...
    public static class HistoryF2 {
        ...
        @XmlElement(name = "OperationB", namespace = "http://fsrar.ru/WEGAIS/ReplyHistForm2")
        protected List<OperationBType2> operationB;
         ...
         * {@link OperationBType2 }
         * 
         * 
         */
        public List<OperationBType2> getOperationB() {
            if (operationB == null) {
                operationB = new ArrayList<OperationBType2>();
            }
