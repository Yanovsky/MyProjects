...
@XmlType(name = "InformBTypeRegItem", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", propOrder = {

})
public class InformBTypeRegItem {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", required = true)
