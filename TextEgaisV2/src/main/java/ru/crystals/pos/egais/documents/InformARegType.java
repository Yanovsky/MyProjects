...
@XmlType(name = "InformARegType", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", propOrder = {

})
public class InformARegType {

    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "BottlingDate", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar bottlingDate;
    @XmlElement(name = "TTNNumber", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", required = true)
    protected String ttnNumber;
    @XmlElement(name = "TTNDate", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar ttnDate;
    @XmlElement(name = "EGAISFixNumber", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo")
    protected String egaisFixNumber;
    @XmlElement(name = "EGAISFixDate", namespace = "http://fsrar.ru/WEGAIS/ActInventoryABInfo")
    @XmlSchemaType(name = "date")
