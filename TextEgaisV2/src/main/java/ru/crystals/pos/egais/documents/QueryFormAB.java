...
@XmlType(name = "QueryFormAB", namespace = "http://fsrar.ru/WEGAIS/QueryFormAB", propOrder = {
    "formRegId"
})
public class QueryFormAB {

    @XmlElement(name = "FormRegId", namespace = "http://fsrar.ru/WEGAIS/QueryFormAB", required = true)
