...
@XmlType(name = "ActWriteOffShopPositionType", namespace = "http://fsrar.ru/WEGAIS/ActWriteOffShop_v2", propOrder = {

})
public class ActWriteOffShopPositionType {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ActWriteOffShop_v2", required = true)
    protected String identity;
    @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/ActWriteOffShop_v2", required = true)
    protected ProductInfoV2 product;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ActWriteOffShop_v2", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "MarkCodeInfo", namespace = "http://fsrar.ru/WEGAIS/ActWriteOffShop_v2")
