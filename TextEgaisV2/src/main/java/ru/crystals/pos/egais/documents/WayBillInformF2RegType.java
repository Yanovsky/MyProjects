...
@XmlType(name = "WayBillInformF2RegType", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", propOrder = {
    "header",
    "content"
})
public class WayBillInformF2RegType {

    @XmlElement(name = "Header", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
    protected WayBillInformF2RegType.Header header;
    @XmlElement(name = "Content", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
    ...
    public static class Content {
        ...
        @XmlElement(name = "Position", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
    ...
    public static class Header {
        ...
        @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg")
        protected String identity;
        @XmlElement(name = "WBRegId", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
        protected String wbRegId;
        @XmlElement(name = "EGAISFixNumber", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg")
        protected String egaisFixNumber;
        @XmlElement(name = "EGAISFixDate", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg")
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar egaisFixDate;
        @XmlElement(name = "WBNUMBER", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
        protected String wbnumber;
        @XmlElement(name = "WBDate", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
        @XmlSchemaType(name = "date")
        protected XMLGregorianCalendar wbDate;
        @XmlElement(name = "Shipper", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
        protected OrgInfoRusV2 shipper;
        @XmlElement(name = "Consignee", namespace = "http://fsrar.ru/WEGAIS/TTNInformF2Reg", required = true)
