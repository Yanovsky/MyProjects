...
@XmlType(name = "ReplySpirit_v2", namespace = "http://fsrar.ru/WEGAIS/ReplySpirit_v2", propOrder = {
    "products"
})
public class ReplySpiritV2 {

    @XmlElement(name = "Products", namespace = "http://fsrar.ru/WEGAIS/ReplySpirit_v2", required = true)
    ...
    public static class Products {
        ...
        @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/ReplySpirit_v2")
