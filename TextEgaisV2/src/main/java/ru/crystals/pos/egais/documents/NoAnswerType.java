...
@XmlType(name = "NoAnswerType", namespace = "http://fsrar.ru/WEGAIS/ReplyNoAnswerTTN", propOrder = {
    "wbRegID",
    "ttnNumber",
    "ttnDate",
    "shipper"
...
public class NoAnswerType {
    ...
    @XmlElement(name = "WbRegID", namespace = "http://fsrar.ru/WEGAIS/ReplyNoAnswerTTN", required = true)
    ...
    @XmlElement(name = "Shipper", namespace = "http://fsrar.ru/WEGAIS/ReplyNoAnswerTTN", required = true)
