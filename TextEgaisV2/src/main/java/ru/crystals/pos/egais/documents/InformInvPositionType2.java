...
@XmlType(name = "InformInvPositionType", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", propOrder = {
...
public class InformInvPositionType2 {
    ...
    @XmlElement(name = "InformF1RegId", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
    protected String informF1RegId;
    @XmlElement(name = "InformF2", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
    protected InformInvPositionType2 .InformF2 informF2;
     ...
     * @return
     *     possible object is
     *     {@link InformInvPositionType2 .InformF2 }
     *     
     */
    public InformInvPositionType2 .InformF2 getInformF2() {
        return informF2;
    }
     ...
     *     
     */
    public void setInformF2(InformInvPositionType2 .InformF2 value) {
        this.informF2 = value;
    }
    ...
    public static class InformF2 {
        ...
        @XmlElement(name = "InformF2Item", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
