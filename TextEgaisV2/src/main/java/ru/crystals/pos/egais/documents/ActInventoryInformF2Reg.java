...
@XmlType(name = "ActInventoryInformF2Reg", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", propOrder = {

})
public class ActInventoryInformF2Reg {

    @XmlElement(name = "Header", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
    protected ActInventoryInformF2Reg.Header header;
    @XmlElement(name = "Content", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
    ...
    public static class Content {
        ...
        @XmlElement(name = "Position", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
        protected List<InformInvPositionType2> position;
         ...
         * {@link InformInvPositionType2 }
         * 
         * 
         */
        public List<InformInvPositionType2> getPosition() {
            if (position == null) {
                position = new ArrayList<InformInvPositionType2>();
            }
    ...
    public static class Header {
        ...
        @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg")
        protected String identity;
        @XmlElement(name = "ActRegId", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
        protected String actRegId;
        @XmlElement(name = "Number", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformF2Reg", required = true)
