...
@XmlType(name = "ReplyBarcode", namespace = "http://fsrar.ru/WEGAIS/ReplyBarcode", propOrder = {

})
public class ReplyBarcode {

    @XmlElement(name = "QueryNumber", namespace = "http://fsrar.ru/WEGAIS/ReplyBarcode", required = true)
    protected String queryNumber;
    @XmlElement(name = "Date", namespace = "http://fsrar.ru/WEGAIS/ReplyBarcode", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar date;
    @XmlElement(name = "Marks", namespace = "http://fsrar.ru/WEGAIS/ReplyBarcode", required = true)
    ...
    public static class Marks {
        ...
        @XmlElement(name = "Mark", namespace = "http://fsrar.ru/WEGAIS/ReplyBarcode", required = true)
