...
@XmlType(name = "OrgInfoEx", namespace = "http://fsrar.ru/WEGAIS/ClientRef", propOrder = {

})
public class OrgInfoEx {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ClientRef")
    protected String identity;
    @XmlElement(name = "ClientRegId", namespace = "http://fsrar.ru/WEGAIS/ClientRef", required = true)
    protected String clientRegId;
    @XmlElement(name = "FullName", namespace = "http://fsrar.ru/WEGAIS/ClientRef", required = true)
    protected String fullName;
    @XmlElement(name = "ShortName", namespace = "http://fsrar.ru/WEGAIS/ClientRef")
    ...
    @XmlElement(name = "KPP", namespace = "http://fsrar.ru/WEGAIS/ClientRef")
    ...
    @XmlElement(namespace = "http://fsrar.ru/WEGAIS/ClientRef")
