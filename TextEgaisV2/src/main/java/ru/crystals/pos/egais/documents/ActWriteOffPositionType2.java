...
@XmlType(name = "ActWriteOffPositionType", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff_v2", propOrder = {

})
public class ActWriteOffPositionType2 {

    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff_v2", required = true)
    protected String identity;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff_v2", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "InformF1F2", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff_v2", required = true)
    protected InformF1F2 informF1F2;
    @XmlElement(name = "MarkCodeInfo", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff_v2")
