...
@XmlType(name = "InformInvPositionType", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformBReg", propOrder = {
...
public class InformInvPositionType {
    ...
    @XmlElement(name = "InformARegId", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformBReg", required = true)
    protected String informARegId;
    @XmlElement(name = "InformB", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformBReg", required = true)
    ...
    public static class InformB {
        ...
        @XmlElement(name = "InformBItem", namespace = "http://fsrar.ru/WEGAIS/ActInventoryInformBReg", required = true)
