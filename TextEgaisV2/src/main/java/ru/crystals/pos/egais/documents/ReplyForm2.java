...
@XmlType(name = "ReplyForm2", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", propOrder = {

})
public class ReplyForm2 {

    @XmlElement(name = "InformF2RegId", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    protected String informF2RegId;
    @XmlElement(name = "TTNNumber", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    protected String ttnNumber;
    @XmlElement(name = "TTNDate", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar ttnDate;
    @XmlElement(name = "Shipper", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    protected OrgInfoRusReplyV2 shipper;
    @XmlElement(name = "Consignee", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    protected OrgInfoReplyV2 consignee;
    @XmlElement(name = "ShippingDate", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar shippingDate;
    @XmlElement(name = "Product", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    protected ProductInfoReplyV2 product;
    @XmlElement(name = "Quantity", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2", required = true)
    protected BigDecimal quantity;
    @XmlElement(name = "MarkInfo", namespace = "http://fsrar.ru/WEGAIS/ReplyForm2")
