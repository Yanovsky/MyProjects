...
@XmlType(name = "ActWriteOffType", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", propOrder = {
    "identity",
    "header",
    "content"
})
public class ActWriteOffType {
    ...
    @XmlElement(name = "Identity", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff")
    protected String identity;
    @XmlElement(name = "Header", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", required = true)
    protected ActWriteOffType.Header header;
    @XmlElement(name = "Content", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", required = true)
    ...
    public static class Content {
        ...
        @XmlElement(name = "Position", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", required = true)
    ...
    public static class Header {
        ...
        @XmlElement(name = "ActNumber", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", required = true)
        protected String actNumber;
        @XmlElement(name = "ActDate", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", required = true)
        @XmlSchemaType(name = "date")
        @XmlJavaTypeAdapter(DateAdapter.class)
        protected XMLGregorianCalendar actDate;
        @XmlElement(name = "TypeWriteOff", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff", required = true)
        @XmlSchemaType(name = "string")
        protected TypeWriteOff2 typeWriteOff;
        @XmlElement(name = "Note", namespace = "http://fsrar.ru/WEGAIS/ActWriteOff")
         ...
         *
         */
        public TypeWriteOff2 getTypeWriteOff() {
            return typeWriteOff;
        }
         ...
         *
         */
        public void setTypeWriteOff(TypeWriteOff2 value) {
